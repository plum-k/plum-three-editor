...
export class PostProcessingComponent extends Component {
    ...
    constructor(options: IPostProcessingOptions) {
        super(options);
        const renderer = this.viewer.renderComponent.renderer;
    ...
    addRenderPass() {
        ...
        this.renderPass = new RenderPass(scene, this.viewer.cameraComponent.camera);
    ...
    initEffectPass() {
        ...
        this.effectPass = new EffectPass(this.viewer.cameraComponent.camera, ...this.effects);
    }
