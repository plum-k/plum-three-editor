...
export interface IDebugComponentOptions extends IComponentOptions {
    showMs?: boolean;
    showMb?: boolean;
    showFps?: boolean;
...
export class DebugComponent extends Component<IDebugComponentOptions> {
    stats: Stats | undefined
    subscription: Subscription | undefined
    #enable = false

    constructor(options: IDebugComponentOptions) {
        super(options);
