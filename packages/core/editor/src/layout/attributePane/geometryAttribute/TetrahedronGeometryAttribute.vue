...
const sync = () => {
  ...
  if (object && isMesh(object) && isTetrahedronGeometry(object.geometry)) {
...
objectAttributeChangeSubject.subscribe((editValue) => {
  ...
  if (name === 'name') {
    ...
    const geometry = object.geometry as THREE.TetrahedronGeometry;
...
// ui -> three
const threeToUi = (geometry: THREE.TetrahedronGeometry) => {
