...
import {isDodecahedronGeometry, isMesh} from "three-is";
...
const sync = () => {
  ...
  if (object && isMesh(object) && isDodecahedronGeometry(object.geometry)) {
...
objectAttributeChangeSubject.subscribe((editValue) => {
  ...
  if (name === 'name') {
    ...
    const geometry = object.geometry as THREE.DodecahedronGeometry;
...
// ui -> three
const threeToUi = (geometry: THREE.DodecahedronGeometry) => {
